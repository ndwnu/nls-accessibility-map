...
import nu.ndw.nls.accessibilitymap.backend.openapi.model.v1.RoadOperatorJson.RoadOperatorTypeEnum;
...
public class RoadOperatorMapper {
    ...
    private RoadOperatorTypeEnum mapRoadOperatorType(
            nu.ndw.nls.accessibilitymap.backend.openapi.model.v2.RoadOperatorJson.RoadOperatorTypeEnum roadOperatorTypeEnum) {
