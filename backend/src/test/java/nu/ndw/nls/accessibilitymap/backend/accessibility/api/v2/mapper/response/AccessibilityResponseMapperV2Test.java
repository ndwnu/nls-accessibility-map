...
class AccessibilityResponseMapperV2Test {
    ...
    void setUp() {
        ...
        accessibilityResponseMapperV2 = new AccessibilityResponseMapperV2(accessibilityReasonsJsonMapperV2);
    }
    ...
    void map(Boolean includeAccessibleAndInAccessibleRoadSections) throws JsonProcessingException {
        ...
        AccessibilityResponseJson response = accessibilityResponseMapperV2.map(accessibilityRequestJson, accessibility);
    ...
    @Test
    void map_noAccessibilityRoadSection() throws JsonProcessingException {
