...
class TransportTypeMapperTest {
     ...
     */
    @Test
    void map_ok_lightCommercialVehicleWithTrailer() {
        VehicleArguments vehicleArguments = VehicleArguments.builder()
     ...
     */
    @Test
    void map_ok_motorcycleWithoutTrailer() {
        VehicleArguments vehicleArguments = VehicleArguments.builder()
     ...
     */
    @Test
    void map_ok_tractorWithTrailer() {
        VehicleArguments vehicleArguments = VehicleArguments.builder()
    ...
    void map_ok() {
        ...
        List<VehicleTypeJson> actualList = transportTypeMapper.map(transportTypeSet);
