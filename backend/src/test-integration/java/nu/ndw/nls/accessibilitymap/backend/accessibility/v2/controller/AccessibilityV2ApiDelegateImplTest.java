package nu.ndw.nls.accessibilitymap.backend.accessibility.v2.controller;

import static net.javacrumbs.jsonunit.assertj.JsonAssertions.assertThatJson;
import static nu.ndw.nls.accessibilitymap.backend.openapi.model.v2.ReasonJson.TypeEnum.ACCESSIBLE_REASON;
import static nu.ndw.nls.accessibilitymap.backend.openapi.model.v2.ReasonJson.TypeEnum.VEHICLE_TYPE_REASON;
...
import nu.ndw.nls.accessibilitymap.backend.accessibility.v2.validator.AccessibilityRequestValidator;
                                        ...
                                        .reasons(List.of(List.of(
                                                VehicleTypeReasonJson.builder()
                                                        .becauseOf(List.of(TrafficSignRestrictionJson.builder()
                                                                ...
                                                                .build()))
                                                        .type(VEHICLE_TYPE_REASON)
                                                        .condition(ReasonConditionJson.EQUALS)
                                                        .unitSymbol(ReasonUnitSymbolJson.ENUM)
                                                        .values(List.of(VehicleTypeJson.CAR))
                                                        .build(),
                                                AccessibleReasonJson.builder()
                                                        .becauseOf(List.of(RoadSectionRestrictionJson.builder()
                                                                .type(ROAD_SECTION)
                                                                .roadSectionId(123L)
                                                                .build()))
                                                        .type(ACCESSIBLE_REASON)
                                                        .condition(ReasonConditionJson.EQUALS)
