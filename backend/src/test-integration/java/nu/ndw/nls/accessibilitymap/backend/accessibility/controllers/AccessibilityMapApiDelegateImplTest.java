...
import nu.ndw.nls.accessibilitymap.backend.generated.api.v1.AccessibilityMapApiController;
...
class AccessibilityMapApiDelegateImplTest {
    ...
    @Mock
    private Collection<RoadSection> accessibleRoadsSectionsWithoutAppliedRestrictions;

    @Mock
    private Collection<RoadSection> accessibleRoadSectionsWithAppliedRestrictions;

    @Mock
    private Collection<RoadSection> combinedAccessibility;

    @Mock
    private Optional<RoadSection> toRoadSection;
