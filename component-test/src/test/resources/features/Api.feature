...
#      | endLatitude | endLongitude | municipalityId | vehicleType | fuelTypes | emissionClass | vehicleWidth | exemptionEmissionZoneIds | exemptionEmissionZoneTypes|
...
#      | startLatitude | endLongitude | municipalityId | vehicleType | fuelTypes | emissionClass | vehicleWidth |
#      | 3             | 7              | GM0001         | truck       | diesel    | euro_3        | 2            |
#    Then we expect geojson to match response.emission-zone.geojson


  Scenario: Emission zone - Exemptions active
#    Given a simple Graph Hopper network
#    And graphHopper data is reloaded
#    And with traffic signs
#      | startNodeId | endNodeId | fraction | rvvCode | blackCode | directionType | emissionZoneId | id                                   |
...
#      | 6             | false             | false              |
    When request accessibility for
      | endLatitude | endLongitude | municipalityId | vehicleType | fuelTypes | emissionClass | vehicleWidth | exemptionEmissionZoneIds | exemptionEmissionZoneTypes |
      | 1           | 1            | GM0001         | truck       | diesel    | euro_3        | 2            | zone-zero                |                            |
...
#      | endLatitude | endLongitude | municipalityId | vehicleType | fuelTypes | emissionClass | vehicleWidth |
#      | 3           | 7            | GM0001         | truck       | diesel    | euro_3        | 2            |
#    Then we expect geojson to match response.emission-zone.exemptions-active.geojson
#    When request accessibility geojson for
#      | endLatitude | endLongitude | municipalityId | vehicleType | fuelTypes | emissionClass | vehicleWidth | exemptionEmissionZoneIds | exemptionEmissionZoneTypes |
#      | 3           | 7            | GM0001         | truck       | diesel    | euro_3        | 2            | zone-zero                |                            |
#    Then we expect geojson to match response.emission-zone.exemptions-active.exempt.geojson