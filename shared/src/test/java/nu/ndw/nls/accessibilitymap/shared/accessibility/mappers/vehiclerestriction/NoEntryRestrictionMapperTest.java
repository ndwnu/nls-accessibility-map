package nu.ndw.nls.accessibilitymap.shared.accessibility.mappers.vehiclerestriction;
    ...
    void getStatement_ok_isRestricted() {
        ...
        assertThat(result).isPresent()
                .hasValueSatisfying(statement -> {
                    Assertions.assertEquals("car_access_forbidden == true", statement.getCondition());
                    Assertions.assertEquals("0", statement.getValue());
                    Assertions.assertEquals(Op.MULTIPLY, statement.getOperation());
                });
    }
