...
import nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.Exemption;
import nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.Restriction;
...
class EmissionZoneMapperTest {
    ...
    private nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZone emissionZoneDto;
    ...
    void setUp() {
        ...
        emissionZoneDto = nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZone.builder()
                .id(EMISSION_ZONE_ID)
                ...
                .restriction(Restriction.builder()
                        ...
                        .fuelType(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.FuelType.DIESEL)
