...
class EmissionZoneTypeMapperTest {
    ...
    @ParameterizedTest
    @EnumSource(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZoneType.class)
    @NullSource
    void map(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZoneType emissionZoneType) {
    ...
    public EmissionZoneType map_emissionZoneType(
            nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZoneType emissionZoneType) {
