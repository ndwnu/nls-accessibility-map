...
class SupplementaryTrafficSignTypeMapperTest {
    ...
    void map(SignCodeEnum signCodeEnum) {
        SupplementarySignType expectedResult = mapToSupplementarySignType(signCodeEnum);

        assertThat(supplementaryTrafficSignTypeMapper.map(signCodeEnum)).isEqualTo(expectedResult);
    }
    ...
    private SupplementarySignType mapToSupplementarySignType(SignCodeEnum signCodeEnum) {
