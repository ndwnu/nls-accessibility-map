...
class FuelTypeMapperTest {
    ...
    @ParameterizedTest
    @EnumSource(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.FuelType.class)
    @NullSource
    void map_fuelType(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.FuelType fuelType) {
    ...
    private Set<FuelType> mapFuelTypes(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.FuelType fuelType) {
