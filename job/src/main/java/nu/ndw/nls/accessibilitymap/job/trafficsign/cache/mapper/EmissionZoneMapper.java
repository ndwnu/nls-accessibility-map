...
public class EmissionZoneMapper {
    ...
    public EmissionZone map(String trafficRegulationOrderId) {
        ...
        return emissionService.findByTrafficRegulationOrderId(trafficRegulationOrderId)
                .filter(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZone::isActive)
                .map(emissionZone -> {
                    try {
    ...
    private EmissionZoneRestriction mapRestriction(nu.ndw.nls.accessibilitymap.job.trafficsign.emission.dto.EmissionZone emissionZone) {
