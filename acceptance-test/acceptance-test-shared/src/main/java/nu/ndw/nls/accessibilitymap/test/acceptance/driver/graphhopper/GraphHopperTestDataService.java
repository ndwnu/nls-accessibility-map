...
public class GraphHopperTestDataService {
    ...
    public GraphHopperDriver buildDirectionalNetworkWithCarInaccessibleLinks() {
          /*
         6----5-----4
         |    |     |
         |    11-10 |
        ...
        return graphHopperDriver
                ...
                .createRoad(4, 5).createRoad(5, 6).createDirectionalRoad(6, 1, Set.of(Direction.BACKWARD))
