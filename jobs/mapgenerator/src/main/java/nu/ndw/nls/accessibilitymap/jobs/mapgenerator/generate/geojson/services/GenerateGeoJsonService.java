...
//
//    public void generate( TrafficSignType trafficSignType,
...
//
//        log.info("Generating geojson: {} version: {} based on NWB version: {}", trafficSignType, version, nwbVersion);
//
//        VehicleProperties vehicleProperties = vehicleTypeVehiclePropertiesMapper.map(trafficSignType);
//
...
//                enrichTrafficSignService.addTrafficSigns(trafficSignType, accessibilityRoadSectionsGroupedById.values());
//
