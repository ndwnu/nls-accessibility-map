...
class MultiPolygonFactoryTest {
    ...
    @Test
    void createMultiPolygon_lowerLIne() throws Exception {
        ...
        RoadSectionFragment roadSectionFragmentWithAccessibleSegmentsLowerLine = RoadSectionFragment.builder().build();
        roadSectionFragmentWithAccessibleSegmentsLowerLine.setForwardSegment(
                buildDirectionSegment(roadSectionFragmentWithAccessibleSegmentsLowerLine, true, 0.75, 1.25, 2, 0.5));

        List<RoadSectionFragment> roadSectionFragments = List.of(
//                roadSectionFragmentWithInaccessibleSegments,
                roadSectionFragmentWithAccessibleSegmentsLowerLine
//                roadSectionFragmentWithAccessibleSegmentsOuter
        );
