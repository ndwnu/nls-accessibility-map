...
class FuelTypeMapperTest {
    ...
    @ParameterizedTest
    @EnumSource(nu.ndw.nls.accessibilitymap.jobs.data.analyser.emission.dto.FuelType.class)
    @NullSource
    void map_fuelType(nu.ndw.nls.accessibilitymap.jobs.data.analyser.emission.dto.FuelType fuelType) {
    ...
    private Set<FuelType> mapFuelTypes(nu.ndw.nls.accessibilitymap.jobs.data.analyser.emission.dto.FuelType fuelType) {
