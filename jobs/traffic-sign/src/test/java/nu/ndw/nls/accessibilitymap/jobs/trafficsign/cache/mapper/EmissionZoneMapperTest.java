...
class EmissionZoneMapperTest {
    ...
    private static final String emissionZoneId = "emissionZoneId";
    ...
    private nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.EmissionZone emissionZoneDto;
    ...
    void setUp() {
        ...
        emissionZoneDto = nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.EmissionZone.builder()
                .id("id")
                .type(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.EmissionZoneType.LOW_EMISSION_ZONE)
                ...
                .status(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.EmissionZoneStatus.ACTIVE)
                .exemptions(List.of(Exemption.builder()
                        .id("exemption")
                        .startTime(OffsetDateTime.parse("2022-03-11T09:00:00.000-01:00", DateTimeFormatter.ISO_OFFSET_DATE_TIME))
                        .endTime(OffsetDateTime.parse("2022-03-11T10:00:00.000-01:00", DateTimeFormatter.ISO_OFFSET_DATE_TIME))
                        .euroClassifications(Set.of(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.EuroClassification.EURO_1))
                        .vehicleWeightInKg(2)
                        .vehicleCategories(Set.of(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.VehicleCategory.M_1))
                        .build()))
                .restriction(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.Restriction.builder()
                        .id("restrictionId")
                        .vehicleCategories(Set.of(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.VehicleCategory.M_2))
                        .fuelType(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.FuelType.DIESEL)
                        .vehicleType(nu.ndw.nls.accessibilitymap.jobs.trafficsign.emission.dto.VehicleType.CAR)
                        .build())
                .build();
    ...
    void map() {
        ...
        when(emissionService.findById(emissionZoneId)).thenReturn(Optional.of(emissionZoneDto));
        ...
        EmissionZone emissionZone = emissionZoneMapper.map(emissionZoneId);
    ...
    void map_unexpectedErrorOccurred() {
        ...
        assertThat(emissionZoneMapper.map(emissionZoneId)).isNull();

        loggerExtension.containsLog(
                Level.ERROR,
                "Emission zone with id '%s' is incomplete and will be skipped." .formatted(emissionZoneId),
