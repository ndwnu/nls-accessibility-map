package nu.ndw.nls.accessibilitymap.accessibility.nwb.mappers;
...
class AccessibilityNwbRoadSectionMapperTest {
    ...
    void map_forwardOnly() {
        ...
        assertEquals(new AccessibilityNwbRoadSection((int) ID, geometry, true, false),
    ...
    void map_reverseOnly() {
        ...
        assertEquals(new AccessibilityNwbRoadSection((int) ID, geometry, false, true),
                accessibleRoadSectionMapper.map(nwbRoadSectionDto));
    }
    ...
    void map_drivingDirectionBeideResultsInBothDirections() {
        ...
        assertEquals(new AccessibilityNwbRoadSection((int) ID, geometry, true, true),
                accessibleRoadSectionMapper.map(nwbRoadSectionDto));
    }
